...
<SEO 
	...
	description="Play virtual arcade games with simulated currency in Rugplay. Try coinflip, slots, mines, dice, tower, and plinko games using virtual money with no real-world value - purely for entertainment."
	keywords="virtual arcade simulation, coinflip game, slots game, mines game, plinko game, virtual arcade, simulated games, entertainment games"
/>

<SignInConfirmDialog bind:open={shouldSignIn} />

<div class="container mx-auto p-3 sm:p-6">
	<h1 class="mb-6 text-center text-2xl font-bold sm:text-3xl">Arcade</h1>
	...
	{:else}
		<div class="mx-auto max-w-4xl space-y-6">
			<!-- Game Selection -->
			<div class="grid grid-cols-3 gap-2 sm:flex sm:flex-wrap sm:justify-center sm:gap-4">
				<Button
